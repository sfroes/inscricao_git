...
namespace SMC.GPI.Administrativo.Areas.INS.Models
{
    public class ConfigurarArquivoSecaoViewModel : SMCViewModelBase, ISMCMappable
    {
        ...
        {
            Arquivos = new SMCMasterDetailList<ConfigurarArquivoSecaoDetalheViewModel>();
        }
        ...
        public SMCMasterDetailList<ConfigurarArquivoSecaoDetalheViewModel> Arquivos { get; set; }
