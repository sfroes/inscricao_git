...
{
    public class AlterarIdiomaEtapaStrategy : SMCFakeStrategyBase
    {
        /// <summary>
        ...
        {
            return !type.IsAbstract && type == typeof(AlterarIdiomaEtapaViewModel);
        }
        ...
        {
            return methodInfo.ReturnType == typeof(AlterarIdiomaEtapaViewModel);
        }
        ...
        {
            return new AlterarIdiomaEtapaViewModel
            {
