...
{
    public class PosicaoConsolidadaPorGrupoOfertaListaData : ISMCMappable
    {
        public long SeqProcesso { get; set; }

        public List<PosicaoConsolidadaPorOfertaListaData> PosicoesConsolidadasOfertas { get; set; }
